        ...
        while (true) {
            ...
            while (selecao != 1 && selecao != 2 && selecao != 3) {
                ...
                System.out.println("""
                        ...
                        2 - Calculadora de Figuras Espaciais
                        3 - Sair
                        """);
                ...
                case (2): {
                    while (true) {
                        try {
                            ...
                            double ladoBase = Calculadora.entrada.nextDouble();
                            System.out.println("Digite o valor da altura em centímetros: \n");
                            double altura = Calculadora.entrada.nextDouble();

                            Piramide p1 = new Piramide(ladoBase, altura);
                            System.out.printf("Volume: %.2fcm³\n", p1.calculaVolume());
                            System.out.printf("Área: %.2fcm²\n", p1.calculaArea());
                            break;
                        } catch (Exception e) {
                ...
                case (6): {
                    while (true) {
                        try {
                            ...
                            System.out.println("Digite o valor do altura em centímetros: \n");
                            double altura = Calculadora.entrada.nextDouble();
                            System.out.println("Digite o valor da geratriz em centímetros: \n");
                            double geratriz = Calculadora.entrada.nextDouble();

                            Cone c1 = new Cone(raio, altura, geratriz);
                            System.out.printf("Volume: %.2fcm³\n", c1.calculaVolume());
                            System.out.printf("Área: %.2fcm²\n", c1.calculaArea());
                            break;
                        } catch (Exception e) {
